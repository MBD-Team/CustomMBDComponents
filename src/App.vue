<template>
  <div id="app" class="container" style="height: 150vh; background-color: green">
    <Checkbox v-model="checkbox" disabled>disabled</Checkbox>
    <Date v-model="DateNull" placeholder="null"></Date>
...
import Number from '../src/components/SexyInputs/Number.vue';
import Text from '../src/components/SexyInputs/Text.vue';
import Range from '../src/components/SexyInputs/Range.vue';
